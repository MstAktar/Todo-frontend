...
var _Todos_instances, _Todos_backend_url, _Todos_readJson, _Todos_addToAray, _Todos_removeFromArray;
//task-4
        ...
        this.addTask = (text) => __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                fetch(__classPrivateFieldGet(this, _Todos_backend_url, "f") + '/new', {
                    ...
                    .then(response => response.json())
                    .then(response => {
                    resolve(__classPrivateFieldGet(this, _Todos_instances, "m", _Todos_addToAray).call(this, response.id, text));
                }), (error) => {
                    reject(error);
                };
            }));
...
}, _Todos_addToAray = function _Todos_addToAray(id, text) {
